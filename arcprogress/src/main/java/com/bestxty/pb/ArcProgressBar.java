...
public class ArcProgressBar extends View {
    ...
    private final static int DEFAULT_FINISHED_COLOR = Color.WHITE;
    private final static float DEFAULT_ARC_ANGLE = 360 * 0.8f;
    ...
    public ArcProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = PxUtil.sp2px(getResources(), 18);
        min_size = (int) PxUtil.dp2px(getResources(), 100);
        default_text_size = PxUtil.sp2px(getResources(), 40);
        default_suffix_text_size = PxUtil.sp2px(getResources(), 15);
        default_suffix_padding = PxUtil.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = PxUtil.sp2px(getResources(), 10);
        default_stroke_width = PxUtil.dp2px(getResources(), 4);
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float finishedStartAngle = 270 - arcAngle / 2f;
        float finishedSweepAngle = progress / (float) getMax() * arcAngle;
        paint.setColor(unfinishedStrokeColor);
        canvas.drawArc(rectF, finishedStartAngle, arcAngle, false, paint);
